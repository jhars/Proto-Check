$(document).ready(function () {
  ...
  var YMALModal = document.getElementById('you-may-also-like-modal');
  ...
  var ctxYMALModal = YMALModal.getContext('2d');
  ...
  $(window).load(function(){
    console.log('load');
      loadPopupImages(sourcesPopup, function(images) {
        ...
        ctxYMALModal.drawImage(imagesPopup.you_may_also_like, 0,0,827,319);
